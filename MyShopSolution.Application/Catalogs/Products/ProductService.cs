...
namespace MyShopSolution.Application.Catalogs.Products
{
    public class ProductService : IProductService
    {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new MyShopException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new MyShopException($"Cannot find a product with id: {productId}");
